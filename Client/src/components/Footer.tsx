...
import { LocateIcon, LucideMail, LucidePhone } from "lucide-react";
              ...
              <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                <li>
                  <a
                    ...
                    rel="noreferrer"
                    target="_blank"
                    className="text-rose-500 transition hover:text-rose-500/75 dark:text-teal-500 dark:hover:text-teal-500/75"
                  >
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:col-span-2">
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  <li>
                    <Link
                      ...
                      href="#"
                    >
                      <LucideMail className="text-rose-500 text-xl" />

                      <span className="flex-1 pl-3 text-gray-300">
                        {" "}
                        john@doe.com{" "}
                      </span>
                    </Link>
                  ...
                  <li>
                    <Link
                      ...
                      href="#"
                    >
                      <LucidePhone className="text-rose-500 text-xl" />
                  ...
                  <li className="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                    <LocateIcon className="text-rose-500 text-xl" />
              ...
              <div className="text-center sm:text-left">
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  <li>
                    <Link
                      className="text-gray-300 transition hover:75  dark:hover:text-white/75"
                      href="#"
                    >
                      Company History
                    </Link>
                  ...
                  <li>
                    <Link
                      className="text-gray-300 transition hover:text-gray-700/75  dark:hover:text-white/75"
                      href="#"
                    >
                      Meet the Team
                    </Link>
              ...
              <div className="text-center sm:text-left">
                ...
                <div className=" items-center gap-3 border inline-flex w-44 px-5 py-1 rounded-md mt-5">
                  <FaGooglePlay className="text-rose-500 text-3xl" />
                ...
                <div className=" items-center gap-3 border inline-flex w-44 px-5 py-1 rounded-md mt-5">
                  <FaAppStoreIos className="text-slate-400 text-3xl" />
                  <div className="text-gray-500">
                    <p className="text-sm">GET IT ON</p>
                    <h1> App Store</h1>
                  </div>
